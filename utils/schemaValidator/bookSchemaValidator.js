...
const createBookSchema = Joi.object({
    ...
    lang: Joi.string().alphanum().valid(
        'arabic', 'Arabic', 'ar', 'Ar', 'AR',
        'English', 'english', 'EN', 'En', 'en',
        'ENG', 'Eng', 'eng').required(),
    releaseDate: Joi.date().required(),
    format: Joi.string().alphanum().valid('pdf', 'epub', 'PDF', 'EPUB', 'Epub', 'Pdf', 'unavailable'),
    copyright: Joi.bool(),
...
const filterBooksSchema = Joi.object({
    ...
    'lang', 'releaseDate',
    'format', 'copyright', 'authorName',
    'minPrice', 'maxPrice', 'before', 'after', 'categoryId');
...
}).or('title', 'subTitle', 'desc',
    'lang', 'releaseDate', 'copyright',
    'coverUrl', 'authorId', 'uploaderId', 'publisherId', 'categoryId');
